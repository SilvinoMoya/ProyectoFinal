        ...
        <div class="row">
            <div class="page-header">
                <div class="d-flex align-items-center">
                    <h2 class="page-header-title">Editar Proyecto</h2>
            ...
            <div class="col-xl-12">
                ...
                <div class="widget has-shadow">
                    ...
                    <div class="widget-body">
                        <form method="POST" action="/projects/{{$project->id}}/edit" class="needs-validation" novalidate="">
                          {{ csrf_field() }}
                            <div class="form-group row d-flex align-items-center mb-5">
                                <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Nombre *</label>
                                <div class="col-lg-5">
                                    <input type="text" class="form-control" name="txtNombre" placeholder="Nombre" required="" value="{{$project->nombre}}">
                          ...
                          <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <option value="{{$project->categoria}}">{{$project->categoria}}</option>
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-5">
                                    <select class="form-control" name="select_que_necesitas" required="">
                                      <option value="{{$project->tipo_proyecto}}">{{$project->tipo_proyecto}}</option>  
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <option value="{{$project->tipo_pago}}">{{$project->tipo_pago}}</option>  
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-5">
                                    <input type="number" value="{{$project->pago}}" class="form-control" name="txtPago" placeholder="Monto de pago" required="">
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-lg-5">
                                <textarea name="txtDescripcion" id="txtDescripcion" class="form-control" rows="2" cols="50"  value="" required>{{$project->descripcion}} </textarea> 
                                    <div class="invalid-feedback">
